...
class NumberListViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        viewModel.statisticsButtonHidden.bindTo(statisticsButton.bnd_hidden)
        viewModel.timerText.bindTo(timerLabel.bnd_text)
        viewModel.buttonText.bindTo(nextButton.bnd_title)
        viewModel.characterText.bindTo(charactersLabel.bnd_text)
    }
